        ...
        <div class="section-content">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                    <img src="<?php echo base_url('hawai') ?>/img/steak.jpg" alt="" class="img-fluid shadow w-100">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                    <img src="<?php echo base_url('hawai') ?>/img/salmon-zucchini.jpg" alt="" class="img-fluid shadow w-100">
                </div>
