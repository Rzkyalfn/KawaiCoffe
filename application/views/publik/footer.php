<footer class="mastfoot pb-5 bg-white section-padding pb-0">
	...
	<script src="<?php echo base_url('hawai') ?>/vendor/bootstrap/popper.min.js"></script>
	<script src="<?php echo base_url('hawai') ?>/vendor/bootstrap/bootstrap.min.js"></script>
	<script src="<?php echo base_url('hawai') ?>/vendor/select2/select2.min.js "></script>
	<script src="<?php echo base_url('hawai') ?>/vendor/owlcarousel/owl.carousel.min.js"></script>
	<script src="https://cdn.rawgit.com/noelboss/featherlight/1.7.13/release/featherlight.min.js"></script>
	<script src="<?php echo base_url('hawai') ?>/vendor/stellar/jquery.stellar.js" type="text/javascript" charset="utf-8"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.0.1/js/tempusdominus-bootstrap-4.min.js"></script>

	<!-- Main JS -->
	<script src="<?php echo base_url('hawai') ?>/js/app.min.js "></script>
</body>
</html>